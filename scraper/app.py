...
# Supabase Configuration - use same env vars as BlueReach
...
BUNDESLAENDER = {
    'BY': {'name': 'Bavaria', 'bounds': (47.27, 50.57, 9.87, 13.84)},
...
def index():
    ...
    return jsonify({
        "status": "ok",
        "service": "leadgen-scraper",
        "supabase_connected": supabase is not None,
        "serper_configured": API_KEY is not None
    })
